...
**本帳戶由單一具名人士掌控。公開紀錄中不存在第二個名字。**

- **Rodion R. Davydov（公開使用「Radic Davydov」）— 創辦人暨執行長，同時是佛州 LLC 的註冊代理人。**
  證據：Florida Secretary of State 列 Rodion R Davydov 為 RELIABLESITE.NET LLC 的 **唯一列名幹部（CEO）** 兼註冊代理人（[FL 登記](https://bisprofiles.com/fl/reliablesite-net-l14000189024)）。BBB 檔案獨立列出相同的邁阿密地址與「Rodion Davydov, CEO」（[BBB](https://www.bbb.org/us/fl/miami/profile/web-hosting/reliablesitenet-llc-0633-90409819)）。LowEndBox 刊出具名專訪〈Custom-Built for Success: Interview with Radic Davydov, CEO of ReliableSite〉，描述他原為**軟體工程師**，2006 年在父親買下另一家主機公司失利之後構思了 ReliableSite（[LowEndBox 專訪](https://lowendbox.com/blog/custom-built-for-success-interview-with-radic-davydov-ceo-of-reliablesite/)）。他以 Host Rep 帳號 **「MrRadic」** 在 LowEndTalk 公開發言，並親自回覆硬體與零件成本問題（[LowEndTalk offer thread](https://lowendtalk.com/discussion/218739/us-eu-dedicated-servers-epyc-4545p-ryzen-5800x-intel-core-i9-9900k-more-new-metal-benefits)）。
  **銷售意涵：在 11–50 人規模、他具工程背景、且全網查無任何 VP Infrastructure 或採購職稱的情況下，他極可能就是硬體採購的直接決策者。而且他在技術論壇上公開可觸及，這相當罕見且有價值。**

- **查無外部投資人、查無機構持股。**
  About 頁自稱公司「a financially stable and debt-free company」，且「Our servers and equipment are 100% owned and operated in-house」。佛州申報僅一名幹部，Crunchbase 亦無募資輪、無 PE／VC 背景、無其他會員或經理人。**視為創辦人自有。佛州 LLC 的會員權益非公開紀錄，故股權結構本身無法查證**（[About 頁](https://www.reliablesite.net/about/)）。

- **CEO 以外的任何具名主管或經理人＝GAP。** 查無 CTO、無 VP Infrastructure、無採購主管、無具名機房經理。佛州申報僅列一名幹部。
