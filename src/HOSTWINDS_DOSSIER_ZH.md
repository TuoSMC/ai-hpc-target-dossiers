...
僅取公開紀錄，每列逐一標記 `public-record`｜`unverified`｜`gap`。**「查證後確認不存在」本身即為研究結果，並依此記載。** 以下標示「查無 FEC 紀錄」之各列，均為實際執行並回傳結果的完整查詢，而非取得失敗；此結論取代本檔前一版——前一版僅能記載 FEC 查詢頁遭 JavaScript 阻擋，並正確地拒絕將其寫成 null。

重點結論：**併購雙方七位具名principal——Peter Holden、Dustin Waggoner、Matthew Anderson、Jamie Opalchuk、Jon Biloh、Michael Carr、Corey Hammond——無一人可辨識出任何聯邦政治獻金紀錄。** 每個姓名均以三種方式查詢 FEC Schedule A：依捐獻人姓名、依姓名加州別、依雇主欄位；Hostwinds、HostPapa 與 ColoCrossing 三者亦各自作為雇主字串單獨查詢。整個集團的聯邦政治足跡，僅來自**於雇主欄位自報上述公司之基層員工——三家公司合計 39 筆逐筆申報紀錄，其中無任何 principal。** 併購雙方均無企業 PAC，集團旗下任何品牌亦無聯邦遊說登記。本節最大的未結缺口屬管轄權性質：**HostPapa 為安大略省公司，而 Elections Canada 尚未查詢。**

### 12.1 公開紀錄之政治獻金與查證結果

| 人物 | 職務 | 事實 | 金額＋日期 | 受贈方（FEC 委員會代號） | 標記 | 來源 |
|---|---|---|---|---|---|---|
| **Peter Holden** | Hostwinds LLC 創辦人暨 CEO；併購前唯一所有權人 | **查無 FEC 紀錄——係四輪完整查詢後之結果。** 捐獻人姓名查詢「Peter Holden」全國回傳 **582 筆**逐筆紀錄，但**華盛頓州為零**、**奧克拉荷馬州為零**（Hostwinds 2010 年創立於 Tulsa）、**Tukwila 為零**。該 582 筆分屬明顯不同之他人——馬里蘭州 Columbia 的 HOLDEN, PETER（職業 RETIRED，每月 100 美元捐予 Scalise for Congress）；麻州 Sharon 的 HOLDEN, PETER（The Asta Group）；密蘇里州 Saint Louis 的 HOLDEN, PETER（無業）。**無一列雇主為 Hostwinds**，而雇主欄位查詢 `contributor_employer=Hostwinds`（11 筆）中亦無任何 Holden。以 Seattle 市加姓氏再查一輪，回傳 587 筆寬鬆匹配（Julia、Thomas、Mardie、Marjorie、Jeffrey、Julie Holden，甚至有以 Holden 為名的 Holden Gjuka），**其中並無 Peter** | 無紀錄 | 無紀錄 | **public-record（查證確認為零）** | [FEC Schedule A — Peter Holden, WA](https://www.fec.gov/data/receipts/individual-contributions/?contributor_name=Peter+Holden&contributor_state=WA) |
| **Dustin Waggoner** | Hostwinds LLC 營運總監（Director of Operations） | **查無 FEC 紀錄。** 捐獻人姓名查詢「Dustin Waggoner」跨所有選舉週期、所有州別，回傳 **count 為 0**。雇主欄位查詢 `contributor_employer=Hostwinds`（11 筆）中無任何 Waggoner。放寬為姓氏查詢（「Waggoner」＋`contributor_state=WA`）回傳 **2,152 筆**互不相關之華盛頓州 Waggoner——例如 Raymond WA 的 FRED L WAGGONER，退休之 Machinists 工會代表——**無一人名為 Dustin，亦無一人任職 Hostwinds** | 無紀錄 | 無紀錄 | **public-record（查證確認為零）** | [FEC Schedule A — Dustin Waggoner](https://www.fec.gov/data/receipts/individual-contributions/?contributor_name=Dustin+Waggoner) |
| **Matthew Anderson** | Hostwinds LLC 後端開發總監（Director of Backend Development） | **查無可歸屬之紀錄——常見姓名撞名，據實載明。**「Matthew Anderson」單就華盛頓州即回傳 **392 筆**逐筆紀錄。已檢視之每一筆華盛頓州紀錄，雇主皆為他者（自僱音樂教師、King County Metro 薪資專員等）；**無一列 Hostwinds。** 雇主欄位查詢 `contributor_employer=Hostwinds`（11 筆）中亦無任何 Anderson。既無任何紀錄可將此姓名連結至該雇主，**即無任何捐獻可歸屬於 Hostwinds 的 Matthew Anderson。** 須取得中間名縮寫、郵遞區號或雇主欄位紀錄方能定人 | 無可歸屬紀錄 | 無可歸屬紀錄 | **unverified** | [FEC Schedule A — Matthew Anderson, WA](https://www.fec.gov/data/receipts/individual-contributions/?contributor_name=Matthew+Anderson&contributor_state=WA) |
| **Jamie Opalchuk** | HostPapa, Inc.（收購方，安大略省 Burlington）創辦人暨 CEO | **查無 FEC 紀錄。** 捐獻人姓名查詢「Jamie Opalchuk」回傳 **count 0**。僅以姓氏「Opalchuk」查詢，**恰好回傳 3 筆**——皆為 2023-05-24、各 1.00 美元捐予 WinRed，捐獻人為佛州 Jacksonville 的 TATYANA、YULI 與 DANIELLA OPALCHUK（雇主 Fine Designs Inc. 與 GOCA）。**係不同個人、不同州別、雇主亦無關聯；並無任何依據可將其連結至 Jamie Opalchuk，本檔亦不將其視為其紀錄。** 雇主欄位查詢 `contributor_employer=HostPapa`（13 筆）中無任何 Opalchuk。**在將此 null 解讀為「無政治活動」之前，務必先讀下方加拿大管轄權該列** | 無紀錄 | 無紀錄 | **public-record（查證確認為零）** | [FEC Schedule A — Opalchuk](https://www.fec.gov/data/receipts/individual-contributions/?contributor_name=Opalchuk) |
| **Jon Biloh** | HostPapa 基礎設施事業單位總經理；前 ColoCrossing；依其公開 LinkedIn 個人檔案位於紐約州 | **查無 FEC 紀錄——本列亦補齊前一版「未個別查核」之缺口。** 捐獻人姓名查詢「Jon Biloh」＝ **0**、「Jonathan Biloh」＝ **0**。以「Biloh」作子字串查詢回傳 75 筆，**每一筆皆為不同姓氏**——Spencerport NY、Vanderbilt PA、Sykesville MD 的 BILOHLAVEK；Red Bank NJ 的 BILOHOLOWSKI。雇主欄位查詢 `contributor_employer=ColoCrossing`（15 筆）與 `contributor_employer=HostPapa`（13 筆）中皆無任何 Biloh | 無紀錄 | 無紀錄 | **public-record（查證確認為零）** | [FEC Schedule A — Jon Biloh](https://www.fec.gov/data/receipts/individual-contributions/?contributor_name=Jon+Biloh) |
| **Michael Carr** | HostPapa, Inc. 營運長（COO） | **查無可歸屬之紀錄——常見姓名撞名，且居住地未經查證，兩者疊加。**「Michael Carr」單就華盛頓州即寬鬆匹配 **649 筆**，且回傳結果多為 CARROLL／CARROL 之變體。決定性的檢驗在雇主欄位：`contributor_employer=HostPapa` 回傳 13 筆，**其中無任何 Carr。** 其居住州別無法自任何公開來源確認——其公開 LinkedIn 僅列 HostPapa 而無確認之美國州別——因此無法以城市／州別篩選定人。**依公開紀錄，無任何捐獻可歸屬於此人。** 若其為加拿大居民，下方 Elections Canada 缺口同樣適用於他 | 無可歸屬紀錄 | 無可歸屬紀錄 | **unverified** | [FEC Schedule A — 雇主 HostPapa](https://www.fec.gov/data/receipts/individual-contributions/?contributor_employer=HostPapa) |
| **Corey Hammond** | HostPapa 行銷長（CMO）；Hostwinds 併購案具名媒體聯絡人；依其公開 LinkedIn 個人檔案位於俄亥俄州 Akron | **查無可歸屬之紀錄——全國命中兩筆，且兩筆均明確排除。** 捐獻人姓名查詢「Corey Hammond」全國恰好回傳兩筆：(1) HAMMOND, COREY R. MR.，緬因州 Brunswick，職業 RETIRED，**2022-05-23 捐 50.00 美元**予 Republican National Committee；(2) HAMMOND, COREY，喬治亞州 Conyers，雇主 HONEYWELL，職業 BUILDING AUTOMATION TECHNICIAN，**2021-06-26 捐 10.00 美元**予 ActBlue。**兩者皆不在俄亥俄州，亦皆未列 HostPapa 或任何主機代管業雇主，故兩筆均不歸屬於 HostPapa 的 Corey Hammond。** 雇主欄位查詢 `contributor_employer=HostPapa`（13 筆）中亦無任何 Hammond | 不相符之紀錄日期為 **2022-05-23（50.00 美元）** 與 **2021-06-26（10.00 美元）**；僅為說明查詢已執行及命中為何遭排除而列出，**明確不歸屬於此人** | Republican National Committee（**C00003418**）——不相符；ActBlue（**C00401224**）——不相符 | **unverified（撞名，兩筆命中均已排除）** | [FEC Schedule A — Corey Hammond](https://www.fec.gov/data/receipts/individual-contributions/?contributor_name=Corey+Hammond) |
| **Hostwinds LLC 員工（彙總）** | 於 FEC 雇主欄位自報 Hostwinds 之員工——**其中無任何具名 principal** | **雇主層級發現，亦是 Hostwinds 這個名字唯一的聯邦政治足跡。** `contributor_employer=Hostwinds` **恰好回傳 11 筆**逐筆紀錄，橫跨 **2015-09-18 至 2024-08-02**，職業包括 lead frontend engineer、IT technician、Linux system administrator、software developer 與 tech support engineer，所在地為 Shoreline WA、University Place WA、Lake Ariel PA 與 Tulsa OK。**11 筆全部流向同一個受贈委員會。** 其中無任何具名 principal；**基層員工姓名於此不予列出，因其為私人個人，且不在本檔範圍內** | **11 筆合計約 146.00 美元**；金額區間 **1.00–50.00 美元**；**2015-09-18 至 2024-08-02** | **ActBlue**（**C00401224**）——全部 11 筆 | **public-record** | [FEC Schedule A — 雇主 Hostwinds](https://www.fec.gov/data/receipts/individual-contributions/?contributor_employer=Hostwinds) |
| **HostPapa 員工（彙總）** | 於 FEC 雇主欄位自報 HostPapa 之員工——**其中無任何具名 principal** | **雇主層級發現（收購方側），且方向與 Hostwinds 該組相反。** `contributor_employer=HostPapa` **恰好回傳 13 筆**逐筆紀錄，期間 **2022-02-28 至 2024-05-31**，捐獻人為俄亥俄州 Columbus 的一名系統管理員與亞利桑那州 Queen Creek 的一名軟體工程師。三個共和黨側委員會於同一日 **2024-05-31** 收受款項；另有十筆各 10.00 美元之 ActBlue 定期捐獻分布於 2022 年。其中無任何具名 principal；員工姓名以私人個人為由不予列出。**此為員工個人捐獻，不能據以推論公司本身之立場** | **13 筆**：**2024-05-31** 對三個共和黨側委員會共 **723.26 美元**；另 **2022 年**十筆各 10.00 美元之 ActBlue 定期捐獻，共 **100.00 美元** | **WinRed**（**C00694323**，249.40 美元）；**Never Surrender, Inc.**（**C00828541**，224.46 美元）；**Trump National Committee JFC, Inc.**（**C00873893**，249.40 美元）；**ActBlue**（**C00401224**，10 × 10.00 美元） | **public-record** | [FEC Schedule A — 雇主 HostPapa](https://www.fec.gov/data/receipts/individual-contributions/?contributor_employer=HostPapa) |
| **ColoCrossing 員工（彙總）** | 自報 ColoCrossing 之員工——該品牌為 HostPapa 姊妹事業、Jon Biloh 先前所領導，亦是承接 Hostwinds 基礎設施之單位；**其中無任何具名 principal** | **雇主層級發現。** `contributor_employer=ColoCrossing` **恰好回傳 15 筆**逐筆紀錄，**全部來自紐約州 Buffalo 的同一名資料中心技術員**，全部集中於 **2016 年 2–4 月**，金額 1.00–50.00 美元。**Jon Biloh 並未出現。** 姓名以私人個人為由不予列出 | **15 筆合計約 167.00 美元**；**2016-02-05 至 2016-04-09** | **ActBlue**（**C00401224**）——全部 15 筆 | **public-record** | [FEC Schedule A — 雇主 ColoCrossing](https://www.fec.gov/data/receipts/individual-contributions/?contributor_employer=ColoCrossing) |
| **HostPapa, Inc.（法人）** | 加拿大收購方，安大略省 Burlington | **管轄權限制，明白陳述，不以隱含方式當作 null。** FEC 之管轄範圍僅及於美國聯邦選舉，且外國人依法（**52 U.S.C. §30121**）不得捐獻美國選舉，故 HostPapa 加拿大籍主管在 FEC 查無紀錄乃**預期之結果，並非其無政治活動之證據。** 加拿大聯邦政治獻金由 **Elections Canada** 另行揭露，安大略省層級則由 **Elections Ontario** 揭露。本次已開啟 Elections Canada 獻金查詢頁並試查姓氏 Opalchuk，惟其表單要求先選定政治實體再加第二項條件，以自動化擷取方式無法取得任何結果集。**Jamie Opalchuk、Michael Carr 及其他任何加拿大籍 HostPapa 主管之加拿大紀錄，屬「尚未查詢」，而非「查詢後為空」。** 應於 Elections Canada 與 Elections Ontario 入口以人工方式補齊 | 管轄權說明 | 管轄權說明 | **gap** | [Elections Canada 獻金查詢](https://www.elections.ca/WPAPPS/WPF/EN/CCS/Index) |
| **`CloudBlue` 雇主字串——刻意排除** | HostPapa 於 2025 年自 Ingram Micro 取得之姊妹品牌 | **`contributor_employer=CloudBlue` 下存在 90 筆 FEC 紀錄，本檔一筆都不採用。** 該雇主字串遠早於 HostPapa 取得 CloudBlue 事業之時點，且捐獻人位於 Santa Clara CA、Boulder CO、Opelika AL 與 Greenwood IN，與 HostPapa 法人並無可證明之連結。**若納入，等同製造一個不存在的關聯。** 於此載明，以免他人重跑查詢後誤以為是漏查 | 依設計排除 | 依設計排除 | **unverified（排除）** | [FEC Schedule A — 雇主 CloudBlue](https://www.fec.gov/data/receipts/individual-contributions/?contributor_employer=CloudBlue) |

#### 受贈機構 — 沿革、政治傾向與負責人

上表中任何一方捐款所流向之每一個委員會，列出其 FEC 登記沿革、政治傾向**及該傾向之證據**，以及其登記在案之負責人。**以下每一項政治傾向，均以該委員會自身之登記文件、公開宣示宗旨或政黨正式背書為證據——無一項是自捐獻人身分、自姓氏、自 Hostwinds 位於華盛頓州、或自主機代管產業所推論而來。** 另須注意貫穿本子表的方法論要點：**此四個委員會全部僅透過針對基層員工之雇主欄位查詢而浮現，從未經由任何具名 principal 而出現。** 姓氏語源註記僅供姓名學參考——使用前請先讀本節末之免責聲明。

| 機構 | 類型 | 沿革 | 政治傾向（＋證據） | 負責人 | 負責人姓氏語源（姓名學） | 來源 |
|---|---|---|---|---|---|---|
| **[ActBlue](https://www.fec.gov/data/committee/C00401224/)**（**C00401224**） | 經 FEC 登記之 **Hybrid PAC**（附 Non-Contribution Account），Nonqualified；designation 為 Unauthorized。實際功能為**獻金導流／處理平台（conduit）**，而非一般意義上的捐款型 PAC。登記地址 PO Box 962017, Boston MA；按月申報。**收受全部 11 筆 Hostwinds 紀錄、全部 15 筆 ColoCrossing 紀錄，以及 13 筆 HostPapa 紀錄中的 10 筆** | 首次 FEC 申報日 **2004-05-17**。2004 年由軟體工程師 **Benjamin Rahn** 與 **Matt DeBergalis** 創立，作為民主黨候選人及委員會之線上小額募款導流平台；其後成長為美國中間偏左陣營最主要之獻金處理平台，聯邦、州及地方民主黨競選團隊與進步派非營利組織均使用之。2025–2026 年間成為**美國眾議院 House Administration 委員會**針對其捐款人審查作業之調查對象；執行長 **Regina Wallace-Jones** 於 **2026-06-10** 出席該委員會作證並主張憲法第五修正案權利 | **民主黨／進步派。** 證據為該組織**自身宣示之宗旨與架構**：ActBlue 公開自述為民主黨候選人及進步派組織之募款平台，其服務條款亦限定平台僅供民主黨與進步派競選及議題使用。其 FEC 申報顯示它擔任民主黨聯邦競選之 earmark conduit，且其於 FEC 在案之關係委員會為 **「Blue to the Future 2024」**。FEC 登載之官方網站為 secure.actblue.com | **Regina Wallace-Jones**——總裁暨執行長（2023 年 1 月上任）· **Matt DeBergalis**——共同創辦人暨董事會主席 · **Benjamin Rahn**——共同創辦人 · **George Gilmer**——FEC 委員會申報上之登記司庫（Treasurer） | **WALLACE**——源自盎格魯-諾曼法語，為「Wallensis」之縮略，來自古法語 *waleis*，意為「威爾斯的」或「外來的」；最早見於蘇格蘭／英格蘭邊境地區。**JONES**——源自人名 John 之父名式姓氏，最終源自拉丁語 *Johannes*，意為「耶和華是仁慈的」；以威爾斯為主，最早見於 Denbighshire。**GILMER**——源自蓋爾語 *Gille Moire*，意為「瑪利亞的追隨者／僕人」，或作為職業名意指「為蘇格蘭族長佩帶闊劍者」；最早見於蘇格蘭 Ayrshire。**RAHN**——德語姓氏；最早見於漢堡與 Holstein 地區——所查參考資料僅載其地理起源，**未載語義**。**DEBERGALIS——GAP。** 所查各姓名學參考資料均無此條目（houseofnames 無頁面；forebears.io 對自動化請求回傳 HTTP 403）——**記為「未能取得」，而非「無語源」** | [FEC C00401224](https://www.fec.gov/data/committee/C00401224/) · [Wikipedia — ActBlue](https://en.wikipedia.org/wiki/ActBlue) · [ActBlue — Regina Wallace-Jones](https://www.actblue.com/posts/introducing-regina-wallace-jones/) · [Roll Call 2026-06-10](https://rollcall.com/2026/06/10/actblue-ceo-invokes-fifth-amendment-to-lawmakers/) · [wallace](https://www.houseofnames.com/wallace-family-crest) · [jones](https://www.houseofnames.com/jones-family-crest) · [gilmer](https://www.houseofnames.com/gilmer-family-crest) · [rahn](https://www.houseofnames.com/rahn-family-crest) |
| **[WinRed](https://www.fec.gov/data/committee/C00694323/)**（**C00694323**） | 經 FEC 登記之 **Hybrid PAC**（附 Non-Contribution Account），Nonqualified；designation 為 Unauthorized。為獻金處理導流平台，**在結構上為 ActBlue 之共和黨對應者**。登記地址 1603 Capitol Avenue, Cheyenne WY；按季申報；法遵聯絡信箱設於 Crosby Ottenhoff Group。**於 2024-05-31 收受一名 HostPapa 員工 249.40 美元** | 首次 FEC 申報日 **2019-01-18**；2019 年公開上線。係在 **Revv** 基礎上建立——該線上捐款平台由前共和黨全國委員會（RNC）數位長 **Gerrit Lansing** 創辦——並在 RNC、NRCC 與 NRSC 背書下設立，作為共和黨統一之小額募款軌道。營運架構為一家營利科技實體（WinRed Technical Services）與 WinRed PAC 之合資。其定期捐款作業曾遭 **Campaign Legal Center** 向 FEC 提出申訴，並受多州檢察總長關注 | **共和黨／保守派。** 證據為該平台**自身宣示之用途與政黨正式背書**：WinRed 公開自述為共和黨候選人及委員會之官方募款技術平台，並於 2019 年在 RNC、NRCC 與 NRSC 明示支持下上線，作為該黨整合之捐款平台。FEC 登載之網站為 win.red | **Gerrit Lansing**——創辦人暨總裁 · **Benjamin Ottenhoff**——FEC 委員會申報上之登記司庫（法遵事務透過 Crosby Ottenhoff Group 處理） | **LANSING**——德語姓氏，源自薩克森；衍生自語素「Lanzo」，意為「土地」或「邦國」，可能為某較長人名之縮略形式，後成為世襲姓氏。**OTTENHOFF——GAP。** 所查各參考資料均無此條目（houseofnames 無敘述性條目；forebears.io 回傳 HTTP 403）。此名之構詞形式常見於荷語／低地德語之地名型姓氏，**惟未能成功取得任何公開姓名學來源佐證，故本檔不作此主張** | [FEC C00694323](https://www.fec.gov/data/committee/C00694323/) · [Wikipedia — WinRed](https://en.wikipedia.org/wiki/WinRed) · [InfluenceWatch](https://www.influencewatch.org/for-profit/winred/) · [Campaign Legal Center 申訴書](https://campaignlegal.org/sites/default/files/2022-07/WinRed_Complaint_Final.pdf) · [lansing](https://www.houseofnames.com/lansing-family-crest) |
| **[Never Surrender, Inc.](https://www.fec.gov/data/committee/C00828541/)**（**C00828541**） | 經 FEC 登記之 PAC——**Qualified**；designation 為 **Leadership PAC**；在案政黨屬性為 **REPUBLICAN PARTY**；連結候選人代號 **P80001571**（Donald J. Trump）。登記地址 P.O. Box 509, Arlington VA；按季申報；在案關係委員會為「Trump Bilirakis Victory Fund」；FEC 登載網站為 donaldjtrump.com。**於 2024-05-31 收受一名 HostPapa 員工 224.46 美元** | 首次 FEC 申報日 **2022-11-15**。該委員會係 **「Donald J. Trump for President 2024, Inc.」** 之後續登記，於 2024 年選舉週期後轉為 leadership PAC；其與其他 Trump 系委員會共用 **Bradley T. Crate** 為司庫，法遵作業均透過其事務所 **Red Curve Solutions, LLC** 處理。該委員會曾被列入 FEC 之 Matters Under Review（**MUR 8251 與 8260**），內容涉及收受受禁止及超額之獻金；Red Curve 之申報作業亦為 2024 年 Campaign Legal Center 申訴之標的 | **共和黨——具體而言為親 Donald Trump 之 leadership PAC。** 證據為該委員會**自身之 FEC 登記文件**：在案政黨屬性 **REPUBLICAN PARTY**、designation「Leadership PAC」、連結候選人代號 **P80001571**（Donald J. Trump）、官方網站 donaldjtrump.com、聯絡信箱 trump@redcurve.com，在案關係委員會為 Trump Bilirakis Victory Fund | **Bradley T. Crate**——登記司庫（Red Curve Solutions, LLC 負責人，該公司為 Trump 系各委員會之法遵服務商）· 發起候選人：**Donald J. Trump**（FEC 候選人代號 P80001571） | **CRATE**——蘇格蘭姓氏，源自蓋爾語 *Mac Rath*，字面意為「恩典之子」或「興旺之子」；歷來於皮克特人後裔中用以指稱富裕之人。**TRUMP**——一般認為源自中古高地德語 *trumpe*，意為「鼓」，或源自布蘭登堡 Uckermark 地區之地名 Trampe；最早見於 Mecklenburg 與 Pomerania | [FEC C00828541](https://www.fec.gov/data/committee/C00828541/) · [FEC MUR 8251](https://www.fec.gov/files/legal/murs/8251/8251_17.pdf) · [Campaign Legal Center — Red Curve 申訴書](https://campaignlegal.org/sites/default/files/2024-04/Red%20Curve%20Reporting%20Complaint%20(Final).pdf) · [ProPublica Itemizer](https://projects.propublica.org/itemizer/committee/C00828541/2024) · [crate](https://www.houseofnames.com/crate-family-crest) · [trump](https://www.houseofnames.com/trump-family-crest) |
| **[Trump National Committee JFC, Inc.](https://www.fec.gov/data/committee/c00873893/)**（**C00873893**） | 經 FEC 登記之 PAC——Nonqualified；designation 為 **Joint Fundraising Committee（聯合募款委員會）**。登記地址 P.O. Box 509, Arlington VA；按季申報；聯絡信箱 trumpnational@redcurve.com。JFC 之功能為匯集獻金，並依書面聯合募款協議分配予各具名參與委員會。**於 2024-05-31 收受一名 HostPapa 員工 249.40 美元** | 首次 FEC 申報日 **2024-03-20**，設立為 2024 年大選 Trump 與共和黨全國委員會之主要聯合募款載體。其參與者為 **Republican National Committee** 與 **Never Surrender, Inc.**，並依 JFC 協議納入各州黨部委員會。OpenSecrets 記載其於 2024 年選舉週期募得約 **4.745 億美元**。與其他 Trump 系委員會相同，由 **Bradley T. Crate** 透過 Red Curve Solutions, LLC 擔任司庫 | **共和黨——Trump／RNC 聯合募款載體。** 證據為該委員會**自身之架構與申報文件**：其向 FEC 登記為聯合募款委員會，具名參與者為 Republican National Committee 與 Never Surrender, Inc.；其與 Trump 系委員會共用 Arlington VA 地址及 Red Curve Solutions 司庫；並以「Trump National Committee」名義於 tnc2024.com 公開勸募 | **Bradley T. Crate**——登記司庫（Red Curve Solutions, LLC）· 參與委員會：**Republican National Committee**；**Never Surrender, Inc.** · **FEC 紀錄未揭露任何獨立之主席、總裁或執行董事**——JFC 係由其司庫與參與委員會共同管理，而非設置獨立之經理人團隊，故**此項空缺是申報文件之事實，而非研究缺口** | **CRATE**——蘇格蘭姓氏，蓋爾語 *Mac Rath*，意為「恩典之子」／「興旺之子」。**TRUMP**——中古高地德語 *trumpe*，意為「鼓」，或源自布蘭登堡 Uckermark 地區之地名 Trampe；最早見於 Mecklenburg 與 Pomerania | [FEC C00873893](https://www.fec.gov/data/committee/c00873893/) · [OpenSecrets 2024 年彙總](https://www.opensecrets.org/political-action-committees-pacs/trump-national-cmte-jfc/C00873893/summary/2024) · [Newsweek](https://www.newsweek.com/donald-trump-launches-fundraising-republican-national-committee-1881663) · [crate](https://www.houseofnames.com/crate-family-crest) · [trump](https://www.houseofnames.com/trump-family-crest) |

#### 州層級紀錄查證結果

每項發現一行。華盛頓州公開揭露委員會（Washington Public Disclosure Commission, PDC）之「Contributions to Candidates and Political Committees」資料集（[data.wa.gov 資源 kv7h-kjye](https://data.wa.gov/resource/kv7h-kjye.json)）涵蓋華盛頓州州級與地方級獻金；本次係直接查詢該資料集，未經查詢入口網頁。

- **Peter Holden——`public-record（查證確認為零）`。** 以捐獻人姓名同時包含 HOLDEN 與 PETER [查詢 WA PDC](https://data.wa.gov/resource/kv7h-kjye.json?$where=upper(contributor_name)%20like%20'%25HOLDEN%25PETER%25')：**恰好回傳一列**——HOLDEN PETER D，**紐約州 New York NY**，雇主 DANSKE MARKETS INC.，職業 FINANCE，**2014-09-12 捐 250.00 美元**予 Mark Burns Nichols 之候選人委員會。**此為紐約金融從業人員，並非西雅圖地區之 Hostwinds 創辦人——明確排除為不相符。** Hostwinds 的 Peter Holden 並無任何 PDC 紀錄。
- **Dustin Waggoner——`public-record（查證確認為零）`。** 以 WAGGONER 與 DUSTIN 任意順序 [查詢 WA PDC](https://data.wa.gov/resource/kv7h-kjye.json?$where=upper(contributor_name)%20like%20'%25WAGGONER%25DUSTIN%25')：**零列。** 任何雇主與主機代管相關之 WAGGONER 亦為零列。
- **Matthew Anderson——`unverified`。** [WA PDC 回傳 50 列以上](https://data.wa.gov/resource/kv7h-kjye.json?$where=upper(contributor_name)%20like%20'%25ANDERSON%25MATTHEW%25'%20AND%20upper(contributor_state)='WA')之華盛頓州 Matthew Anderson 變體——Olympia 某捐獻人之 WA State Troopers PAC 薪資扣繳；西雅圖一名職業 RETIRED 的 Matthew Anderson 於 **2024-07-31 捐 500.00 美元**予 Dave Reichert 競選團隊；以及 Medical Lake、Vancouver 與 Granite Falls 捐獻人之 WEA-PAC、牙醫 PAC 與 Nucor PAC 薪資扣繳。**無一列 Hostwinds 或任何主機代管業雇主，故均不可歸屬。** 此為常見姓名撞名，並非關於此人之發現。
- **Hostwinds LLC 作為雇主——`public-record（查證確認為零）`。** 以 `contributor_employer_name like '%HOSTWIND%'` [查詢 WA PDC](https://data.wa.gov/resource/kv7h-kjye.json?$where=upper(contributor_employer_name)%20like%20'%25HOSTWIND%25')：**零列。** 以雇主含 HOST 分別搭配 Holden、Waggoner、Opalchuk、Biloh、Hammond 各姓氏查詢，亦全為零列。**從未有任何華盛頓州州級或地方級政治獻金以 Hostwinds 為捐獻人雇主申報。**
- **HostPapa, Inc. 與 ColoCrossing 作為雇主——`public-record（查證確認為零）`。** 以 `contributor_employer_name` 含 HOSTPAPA 或 COLOCROSSING [查詢 WA PDC](https://data.wa.gov/resource/kv7h-kjye.json?$where=upper(contributor_employer_name)%20like%20'%25HOSTPAPA%25'%20OR%20upper(contributor_employer_name)%20like%20'%25COLOCROSSING%25')：**零列。**
- **Jamie Opalchuk、Michael Carr、Corey Hammond、Jon Biloh——`public-record（查證確認為零），且多數本不屬此管轄`。** [WA PDC 對 OPALCHUK 回傳零列](https://data.wa.gov/resource/kv7h-kjye.json?$where=upper(contributor_name)%20like%20'%25OPALCHUK%25')、對 BILOH 亦為零列；HAMMOND 與 CARR 僅產生與主機代管業無關之華盛頓州捐獻人。**此四人均無已知之華盛頓州居住事實**——Corey Hammond 公開檔案顯示其位於俄亥俄州 Akron，Jon Biloh 位於紐約州，HostPapa 本身位於安大略省 Burlington——**故華盛頓州本就不是預期會出現其政治活動的管轄區。**
- **華盛頓州「遊說」——`gap`，並非乾淨的零。** 本次查詢之 data.wa.gov 資料集（**bp5b-jrti**）實為**遊說人（lobbyist-agent）登記名冊，並無 `employer_name` 欄位**，故原定之雇主端查詢**是報錯，而非回傳空結果。** 目前並未發現 Hostwinds 或 HostPapa 之華盛頓州遊說登記，惟**在陳述為零之前，須改以 PDC 之 lobbyist-employer（L-1／L-2）資料集或 [PDC 網頁入口](https://www.pdc.wa.gov/political-disclosure-reporting-data/browse-search-data) 重跑一次。**
- **加拿大（聯邦）與安大略省（省級）——`gap`，尚未查詢，明白陳述而非以隱含方式當作不存在。** HostPapa, Inc. 為總部設於安大略省 Burlington 之加拿大公司。**美國 FEC 與華盛頓州 PDC 之紀錄不涵蓋、也不可能涵蓋加拿大之政治獻金**，且美國法律禁止外國人捐獻美國選舉——因此 HostPapa 加拿大籍主管在美國查詢結果為空，屬**管轄權造成的假象，而非其無政治活動之證據。** 本次已開啟 [Elections Canada 獻金查詢](https://www.elections.ca/WPAPPS/WPF/EN/CCS/Index)，惟其表單要求先選定政治實體再加第二項條件，以自動化擷取方式無法取得結果集。**Jamie Opalchuk 與 Michael Carr 之加拿大聯邦及安大略省紀錄仍屬未查核，應以人工方式補查。**
- **其他州——`gap`，範圍說明。** 州層級競選財務僅查核**華盛頓州**。FEC 雇主欄位紀錄顯示自報 Hostwinds 之員工分布於**賓州**與**奧克拉荷馬州**，自報 HostPapa 之員工分布於**俄亥俄州**與**亞利桑那州**；上述各州自身之競選財務入口並未查詢，**因為這些捐獻人皆非具名 principal。**

#### 遊說

**查無任何紀錄——且這是針對主要聯邦來源完成的查詢，不是入口網站失效。**

| 登記人 | 議題／已執行之查詢 | 支出 | 期間 | 來源 |
|---|---|---|---|---|
| **無——Hostwinds LLC 查無任何登記人** | **明確之 GAP 陳述。** 已以 `client_name=Hostwinds` 查詢參議院 Lobbying Disclosure Act 資料庫（lda.senate.gov API v1，`/filings/` 端點）：**count 0**。**無任何 LD-1 登記、亦無任何 LD-2 季度活動報告以 Hostwinds LLC 為客戶或登記人。** Hostwinds 在公開紀錄上無聯邦遊說足跡 | **揭露金額 0 美元——無任何申報存在** | LDA 資料庫涵蓋之全部期間（1999 年至今），未設日期限制 | [Senate LDA API — client Hostwinds](https://lda.senate.gov/api/v1/filings/?client_name=Hostwinds) |
| **無——收購方及任一姊妹品牌均查無登記人** | 同一 LDA 查詢擴及全集團：`client_name=HostPapa` **count 0**；`client_name=ColoCrossing` **0**；`client_name=Hostopia` **0**；`client_name=CloudBlue` **0**；`registrant_name=Hostwinds` **0**。**HostPapa, Inc. 或任何具名之 HostPapa 旗下品牌，均不存在聯邦遊說登記** | **揭露金額 0 美元——無任何申報存在** | LDA 資料庫涵蓋之全部期間（1999 年至今） | [Senate LDA API — client HostPapa](https://lda.senate.gov/api/v1/filings/?client_name=HostPapa) |
| **無可歸屬者——僅以姓氏查詢之遊說人結果均已排除為不相符** | 以遊說人姓氏查詢 LDA `/filings/`：**Holden** 回傳 38 件、**Waggoner** 91 件、**Hammond** 1,106 件——**全部屬於任職於無關事務所之無關註冊遊說人，無一與 Hostwinds、HostPapa、ColoCrossing 或任何主機代管／資料中心客戶有關。** **Opalchuk** 回傳 0、**Biloh** 回傳 0。**Hostwinds 或 HostPapa 之具名 principal，無一人為註冊之聯邦遊說人** | 無可歸屬之申報 | LDA 資料庫涵蓋之全部期間 | [Senate LDA API — lobbyist Opalchuk](https://lda.senate.gov/api/v1/filings/?lobbyist_name=Opalchuk) |
| **OpenSecrets 機構檔案——未能取得** | **GAP，據實記載。** OpenSecrets.org 對自動化請求於捐款人查詢與機構檔案兩條路徑皆回傳 **HTTP 403**，故未取得 Hostwinds 或 HostPapa 之 OpenSecrets 機構檔案。**遊說之結論並不依賴此來源**——OpenSecrets 之遊說資料完全衍生自參議院 LDA 申報，而上述已直接查詢該主要來源，且每一個公司名稱皆回傳零，故結論係建立在主要來源之上。以人工瀏覽器造訪即可補齊此呈現上的缺口 | OpenSecrets 部分未知；依主要來源 LDA 為 **0 美元** | 不適用 | [OpenSecrets 聯邦遊說方法論](https://www.opensecrets.org/federal-lobbying/methodology) |

**非政治性之公開足跡（沿用前版）。** 附著於 Hostwinds 唯一近似監理性質的公開痕跡，與濫用／內容管理有關：一則 Web Hosting Talk 批評其濫用處理的討論串、公開之濫用聯絡管道，以及 [phish.report 條目](https://phish.report/contacts/HOSTWINDS-US)。公司亦曾為整頓 IP 信譽而將 email 行銷業者移出其網路。**上述皆非政治活動，於此載明僅為避免被誤讀為政治活動。**

#### 已執行之查詢

**查詢後有所發現之入口：** 透過 api.open.fec.gov 查詢 [FEC Schedule A](https://www.fec.gov/data/receipts/individual-contributions/)——對全部七位 principal 執行捐獻人姓名、姓名加州別、雇主欄位三種查詢，另單獨查詢雇主字串 Hostwinds（11 筆）、HostPapa（13 筆）、ColoCrossing（15 筆）、Hostopia（11 筆，僅供脈絡參考）與 CloudBlue（90 筆，依設計排除）· 對 C00401224、C00694323、C00828541、C00873893 執行 [FEC 委員會查詢](https://www.fec.gov/data/committees/)（類型、首次申報日、司庫、政黨屬性、候選人連結、關係委員會）· data.wa.gov 之 [華盛頓州 PDC 獻金資料集 kv7h-kjye](https://data.wa.gov/resource/kv7h-kjye.json) · [houseofnames.com](https://www.houseofnames.com) 之 Wallace、Jones、Gilmer、Rahn、Lansing、Crate、Trump 姓氏條目 · 針對併購案、主管名單與委員會沿革之公開網路檢索。

**查詢後一無所獲、或遭阻擋之入口——上述各項缺口是查過的，不是偷懶：** [Senate LDA API](https://lda.senate.gov/api/v1/filings/)（五次 client-name 查詢、一次 registrant 查詢、五次遊說人姓氏查詢——**每一個公司名稱皆為零**）· [Elections Canada 獻金查詢](https://www.elections.ca/WPAPPS/WPF/EN/CCS/Index)（**表單要求互動式選定實體，無法取得結果集——尚未查詢，為本節最大缺口**）· Elections Ontario（**未查詢**）· [WA PDC 遊說人資料集 bp5b-jrti](https://data.wa.gov/resource/bp5b-jrti.json)（**查詢報錯——資料集選錯，該集為遊說人登記名冊，無雇主欄位**）· [OpenSecrets](https://www.opensecrets.org/federal-lobbying/methodology) 捐款人查詢與機構檔案（**對自動化請求回傳 HTTP 403**）· forebears.io 與 ancestry.com 之 Dictionary of American Family Names（**兩者皆 HTTP 403；此即 OTTENHOFF 與 DEBERGALIS 記為「未能取得」而非猜測之原因**）· 賓州、奧克拉荷馬州、俄亥俄州、亞利桑那州之州級競選財務入口（**未查詢——四州之中並無任何具名 principal**）。

**「查無 FEC 紀錄」之兩項限制，兩者皆屬關鍵。** 其一，**FEC 獻金資料僅反映「逐筆申報（itemised）」之獻金及經導流平台申報之 earmark**——低於逐筆申報門檻、且未經 ActBlue 或 WinRed 等導流平台處理之獻金不會出現，故「查無 FEC 紀錄」意指**查無應申報且已申報之獻金，並非保證其政治捐獻為零。** 其二為**可重現性之取用說明**：api.open.fec.gov 之 DEMO_KEY 已達速率上限（HTTP 429，Retry-After 約 4.3 小時），故本次查詢改用 fec.gov 自身於其資料瀏覽器頁面原始碼中公開之 API 金鑰，並帶 fec.gov 之 Referer／Origin 標頭——**即一般訪客造訪 FEC 網站時所走的同一條取用路徑。** 查詢結果並已與 FEC 官方網頁介面交叉比對，該介面就 Peter Holden 於華盛頓州之查詢獨立回傳 **「Showing 0 to 0 of 0 entries」**。

**本軸線結論。** **七位具名 principal、每人三種聯邦查詢方式，結果無一人有可辨識之紀錄。** 集團全部聯邦政治足跡，僅為 39 筆由基層員工所捐、且恰好填寫了雇主名稱的小額獻金——**Hostwinds 側 146 美元、ColoCrossing 側 167 美元，全數流向 ActBlue；HostPapa 側 823 美元，其中約四分之三流向共和黨側。** 兩個方向互相抵銷，且款項屬於員工個人而非任一家公司，**與硬體採購毫無關聯。** 併購雙方均無企業 PAC、無聯邦遊說登記人、無遊說支出——**此處既無可資運用的切入點，也不構成任何風險。** 真正仍屬未知的只有加拿大部分，應交由能以人工操作 Elections Canada 與 Elections Ontario 入口者接手。
